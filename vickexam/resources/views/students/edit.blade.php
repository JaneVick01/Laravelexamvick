                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input name="name" class="input @error('name') is-danger @enderror"
                                                   type="text" placeholder="Your name here..." value="{{ $student->name }}">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea name="cohort"
                                                      ...
                                                      type="text" placeholder="A positive number up to 4294967295...">{{ $student->cohort }}</textarea>
                                        </div>
                                        @error('cohort')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea name="img_url" class="textarea @error('img_url') is-danger @enderror"
                                                      rows="15" placeholder="A link to an image...">{{ $student->img_url }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea name="members"
                                                      ...
                                                      type="text" placeholder="A positive number referenced to the primary key...">{{ $student->id }}</textarea>
                                        </div>
                                        @error('members')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
